"""
Automated Pytest for onco-cardiology-toxicity-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    CardiotoxicitySurveillanceSchedulingEchocardiogramIntervalsEngine,
    GoalEngine,
    DataModelChangesEngine,
    KnowledgeBaseEngine,
    AgentChangesEngine,
    PrioritizeByRiskLevelEngine,
    ApiChangesEngine,
    OncocardiologytoxicityagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = OncocardiologytoxicityagentEnrichmentSuite()
